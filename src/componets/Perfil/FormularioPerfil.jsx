...
import actualizarPerfil from "../../context/AuthProvider";
...
const FormularioPerfil = () => {
    ...
    const handleSubmit = async ( e ) => {
        ...
        if ( Object.values(form).includes("") ) {
            setMensaje({ msg: "Todos los campos son obligatorios", tipo: false});
            setTimeout( () => {
                setMensaje({});
            }, 3000);
            return;
    ...
    return (
        <form onSubmit={handleSubmit}>
            { Object.keys(mensaje).length > 0 && <Mensaje tipo={mensaje.tipo} > {mensaje.msg} </Mensaje> }
            <div>
                <label
                    htmlFor='nombre'
