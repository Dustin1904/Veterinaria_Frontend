...
import Mensaje from '../componets/Perfil/Alertas.jsx';
                ...
                {Object.keys(mensaje).length>0 && <Mensaje tipo={mensaje.tipo}>{mensaje.respuesta}</Mensaje>}
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-1">
                            ...
                            type="email" placeholder="Enter you email" className="block w-full rounded-md border border-gray-300 focus:border-purple-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" />
                        </div>
